...
func (ec *executionContext) field_Mutation_createTask_args(ctx context.Context, rawArgs map[string]any) (map[string]any, error) {
	var err error
	args := map[string]any{}
	arg0, err := graphql.ProcessArgField(ctx, rawArgs, "input", ec.unmarshalNNewTaskInput2githubᚗcomᚋkeodevspaceᚋgoᚑgraphqlᚑapiᚋgraphᚋmodelᚐNewTaskInput)
	if err != nil {
		return nil, err
	}
	args["input"] = arg0
...
func (ec *executionContext) _Mutation_createTask(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		...
		nil,
		ec.marshalNTask2ᚖgithubᚗcomᚋkeodevspaceᚋgoᚑgraphqlᚑapiᚋgraphᚋmodelᚐTask,
		true,
		true,
	)
}
...
func (ec *executionContext) _Query_tasks(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		...
		nil,
		ec.marshalNTask2ᚕᚖgithubᚗcomᚋkeodevspaceᚋgoᚑgraphqlᚑapiᚋgraphᚋmodelᚐTaskᚄ,
		true,
		true,
	)
}
...
func (ec *executionContext) unmarshalNNewTaskInput2githubᚗcomᚋkeodevspaceᚋgoᚑgraphqlᚑapiᚋgraphᚋmodelᚐNewTaskInput(ctx context.Context, v any) (model.NewTaskInput, error) {
...
func (ec *executionContext) marshalNTask2githubᚗcomᚋkeodevspaceᚋgoᚑgraphqlᚑapiᚋgraphᚋmodelᚐTask(ctx context.Context, sel ast.SelectionSet, v model.Task) graphql.Marshaler {
	return ec._Task(ctx, sel, &v)
}

func (ec *executionContext) marshalNTask2ᚕᚖgithubᚗcomᚋkeodevspaceᚋgoᚑgraphqlᚑapiᚋgraphᚋmodelᚐTaskᚄ(ctx context.Context, sel ast.SelectionSet, v []*model.Task) graphql.Marshaler {
	ret := graphql.MarshalSliceConcurrently(ctx, len(v), 0, false, func(ctx context.Context, i int) graphql.Marshaler {
		fc := graphql.GetFieldContext(ctx)
		fc.Result = &v[i]
		return ec.marshalNTask2ᚖgithubᚗcomᚋkeodevspaceᚋgoᚑgraphqlᚑapiᚋgraphᚋmodelᚐTask(ctx, sel, v[i])
	})
...
func (ec *executionContext) marshalNTask2ᚖgithubᚗcomᚋkeodevspaceᚋgoᚑgraphqlᚑapiᚋgraphᚋmodelᚐTask(ctx context.Context, sel ast.SelectionSet, v *model.Task) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			graphql.AddErrorf(ctx, "the requested element is null which the schema does not allow")
		}
